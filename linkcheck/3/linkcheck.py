...
def check_rapidshare(url, conn=None):
    conn = conn or httplib.HTTPConnection("rapidshare.com")
...
class LinkChecker(object):
    def __init__(self, parser_map=None):
        ...
        self.cookie_map = {
            'filefactory.com':'__qca=P0-364353071-1321871204796; FARMID=B; FF_JoinPromo=true; ff_referrer_hash=BBZUB0s; rPopHome=1; ff_membership=SlyL0JODTZMIdfYHy%2F7imNjJjTKzh3fENE4bwnFPzoHrD3dOJN%2F4ZhTFm1XkL4mecNsE1lL9Kl34PuEX0HcaUMWsmJpyVQ%2F8CXPh1d%2Fuo40yLYqjqa1vK5bBGMNga%2BzqBE2hdy9URkUGotc5RUMOkNGrFEGgyJCkq%2BbTDuTUsUnk8j49%2BMZaTVoqUj2%2BHxcB02IH3jp9NwU%3D; FF_PremiumPromo=true'
        }
        ...
        for k in self.parser_map.keys():
            if k in url:
                ...
                if not fetcher:
                    ...
                    fetcher = pu.Fetcher(headers=headers, cookies=0, timeout=12.0) #
